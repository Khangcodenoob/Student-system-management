...
class Student:
    def __init__(self,root):
        ...
        self.create_table()
        self.fetch_data()
        title = Label(self.root,text="Hệ thống quản lý sinh viên",bd=6,relief=GROOVE,font=("Algerian",30,'bold'),bg='dark blue',fg='white' )
        ...
        title = Label(self.root,text="Student Management Software",bd=3,relief=GROOVE,font=("Brush Script MT",18),bg='blue',fg='white' )
